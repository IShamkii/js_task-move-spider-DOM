...
function getPosition({ x, y }) {
    ...
    const leftPosition = Math.min(Math.max(x, leftBoundary), rightBoundary) - leftBoundary;
    const topPosition = Math.min(Math.max(y, topBoundary), bottomBoundary) - topBoundary;
    return {
        leftPosition,
        topPosition
    };
